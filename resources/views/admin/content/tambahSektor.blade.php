...
<div class="row">
                ...
                <div class="row">
                  ...
                  <div class="input-field col s12">
                    ...
                    <div class="col m10 l10">
                      ...
                      <input id="iconsektor" name="iconsektor" type="text" data-error=".errorTxt2" required placeholder="Contoh : creative-commons">
  ...
  <!-- Modal Color -->
  <div id="modalcolors" class="modal modal-fixed-footer" style="width: 80%">
    <div class="modal-content">
